 ...
 */
export function ArrowNext({ className, ...props }: Omit<DirectionalIconProps, 'icon'>) {
 ...
 */
export function ArrowPrev({ className, ...props }: Omit<DirectionalIconProps, 'icon'>) {
 ...
 */
export function ChevronNext({ className, ...props }: Omit<DirectionalIconProps, 'icon'>) {
 ...
 */
export function ChevronPrev({ className, ...props }: Omit<DirectionalIconProps, 'icon'>) {
