    ...
    >
      ...
      >
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle id="debug-panel-title">🐛 Developer Debug Panel</CardTitle>
          <Button
            onClick={onToggle}
            variant="outline"
            size="sm"
              ...
              {performanceData && (
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="space-y-1 text-sm">
                      <p>
                        <strong>LCP:</strong> {performanceData.lcp?.toFixed(2)}
                        ms
                      </p>
                      <p>
                        <strong>FID:</strong> {performanceData.fid?.toFixed(2)}
                        ms
                      </p>
                      <p>
                        <strong>CLS:</strong> {performanceData.cls?.toFixed(3)}
                      </p>
                      <p>
                        <strong>FCP:</strong> {performanceData.fcp?.toFixed(2)}
                        ms
                      </p>
                    </div>
                  </div>
