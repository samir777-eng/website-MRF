...
describe('Button', () => {
  ...
  describe('Interactions', () => {
    it('should handle click events', async () => {
      ...
      const element = screen.getByRole('button') || screen.getByRole('link') || screen.getByTestId('button');
  ...
  describe('Accessibility', () => {
    it('should have proper ARIA attributes', () => {
      const { container } = render(<Button aria-label="Test Button" />);
      const element = container.firstChild;
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle undefined props gracefully', () => {
      const { container } = render(<Button someProp={undefined} />);
      expect(container.firstChild).toBeInTheDocument();
    });

    it('should handle empty string props', () => {
      const { container } = render(<Button className="" />);
      expect(container.firstChild).toBeInTheDocument();
    });
  });
