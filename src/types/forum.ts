...
export const FORUM_CATEGORIES: Record<
  ForumCategory,
  { name: string; nameAr: string; icon: string; color: string }
> = {
  ...
  "study-tips": {
    name: "Study Tips",
    nameAr: "نصائح الدراسة",
    icon: "💡",
    color: "cyan",
  },
  "homework-help": {
    name: "Homework Help",
    nameAr: "مساعدة الواجبات",
    icon: "📚",
    color: "indigo",
  },
};
...
export function getStatusLabel(status: ThreadStatus): {
  en: string;
  ar: string;
} {
  const labels = {
