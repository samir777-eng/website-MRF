...
export type TimeRange = 'today' | 'week' | 'month' | 'semester' | 'year' | 'all';
...
export interface AlertConfig {
  id: string;
  type: 'streak_lost' | 'low_activity' | 'declining_performance' | 'achievement_unlocked';
  threshold: number;
  isEnabled: boolean;
}
...
// Helper functions
export function getTimeRangeLabel(range: TimeRange): { en: string; ar: string } {
