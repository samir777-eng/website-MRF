  ...
  const recentAlerts: EducatorAlert[] = [
    {
      ...
      message: "Performance dropped 15% this week",
      messageAr: "انخفض الأداء بنسبة 15% هذا الأسبوع",
      severity: "warning",
    ...
    },
    {
      ...
      message: "14-day streak lost",
      messageAr: "فقد سلسلة 14 يوم",
      severity: "info",
    ...
    },
    {
      ...
      message: 'Unlocked "Monthly Master" achievement',
      messageAr: 'فتح إنجاز "سيد الشهر"',
      severity: "info",
