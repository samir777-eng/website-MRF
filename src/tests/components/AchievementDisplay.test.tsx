...
describe("AchievementDisplay", () => {
  describe("Rendering", () => {
    ...
    it("should apply custom className", () => {
      const { container } = render(
        <AchievementDisplay className="custom-class" />,
      );
  ...
  describe("Interactions", () => {
    it("should handle click events", async () => {
      ...
      const element =
        ...
        screen.getByTestId("achievementdisplay");
  ...
  describe("Accessibility", () => {
    it("should have proper ARIA attributes", () => {
      const { container } = render(
        <AchievementDisplay aria-label="Test AchievementDisplay" />,
      );
      const element = container.firstChild;
  ...
  describe("Props", () => {
    ...
    it("should handle data attributes", () => {
      const { container } = render(
        <AchievementDisplay data-testid="test-component" />,
      );
  ...
  describe("Edge Cases", () => {
    it("should handle null children gracefully", () => {
      const { container } = render(
        <AchievementDisplay>{null}</AchievementDisplay>,
      );
      expect(container.firstChild).toBeInTheDocument();
    });
  ...
  describe("Performance", () => {
    ...
    it("should not cause memory leaks", () => {
      ...
      expect(
        screen.queryByTestId("achievementdisplay"),
