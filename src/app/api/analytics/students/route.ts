...
function generateMockStudentAnalytics(
  studentId: string,
  timeRange: TimeRange,
): StudentDetailedAnalytics {
  const subjectPerformance: SubjectPerformance[] = [
    {
      ...
      improvement: 5.2,
      weakTopics: ["النحو المتقدم"],
      strongTopics: ["القراءة", "الإملاء"],
    },
    {
      subject: "Mathematics",
      subjectAr: "الرياضيات",
    ...
    },
    {
      ...
      averageTimePerQuestion: 38,
      improvement: 3.5,
      weakTopics: [],
      strongTopics: ["الفيزياء", "الكيمياء"],
    },
    {
      subject: "English",
